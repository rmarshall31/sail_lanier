    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keel', models.PositiveSmallIntegerField(blank=True,
                                                          choices=[(1, 'Centerboard'), (2, 'Daggerboard'), (3, 'Fin'),
                                                                   (4, 'Full'), (5, 'Shoal'), (6, 'Swing'),
                                                                   (7, 'Wing')], null=True)),
                ('prop', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Folding / feathering'),
                                                          ...
                                                          null=True)),
                ('max_headsail', models.PositiveSmallIntegerField(blank=True,
                                                                  choices=[(1, 'Up to 125.0'), (2, '125.1-135.0'),
                                                                           (3, '135.1-145.0'), (4, '145.1-155.0'),
                                                                           (5, '155.1-165.0'), (6, '165.1-175.0'),
                                                                           (7, '175.1-185.0'), (8, '185.1-195.0'),
                                                                           (9, '195.1 and over')], null=True)),
                ...
                ('rig_type',
                 models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Fractional'), (2, 'Masthead')], null=True)),
                ('mast_type',
                 models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Standard'), (2, 'Tall')], null=True)),
                ('spin_type', models.PositiveSmallIntegerField(blank=True,
                                                               choices=[(1, 'Asymmetrical'), (2, 'Symmetrical'),
                                                                        (3, 'Both'), (4, 'None')], null=True)),
                ('spin_pole_length', models.DecimalField(blank=True, decimal_places=2,
                                                         help_text='Enter spin pole length if different than standard.',
                                                         max_digits=5, null=True)),
                ('spin_luff', models.DecimalField(blank=True, decimal_places=2,
                                                  help_text='Enter spin luff length if different than standard',
                                                  max_digits=5, null=True)),
                ('spin_max_girth', models.DecimalField(blank=True, decimal_places=2,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.PositiveSmallIntegerField(choices=[(1, 'new'), (2, 'pending'), (3, 'complete')], default=1)),
                ('comments', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.PositiveSmallIntegerField(
                    choices=[(0, 'None'), (1, 'BFSC'), (2, 'LLSC'), (3, 'SSC'), (4, 'UYC')], default=0)),
